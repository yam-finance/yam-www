...
describe("Distribution", () => {
  ...
  describe("pool failures", () => {
    test("cant join pool 1s early", async () => {
      ...
      await yam.testing.expectThrow(
        yam.contracts.eth_pool.methods
          .stake(
            yam
              .toBigN(200)
      ...
      await yam.testing.expectThrow(
        yam.contracts.ampl_pool.methods.stake("5016536322915819").send({
          from: user,
          gas: 300000,
        }),
        "not start"
    ...
    test("cant withdraw more than deposited", async () => {
      ...
      await yam.contracts.weth.methods
        .transfer(
          user,
          yam
            .toBigN(2000)
      ...
      await yam.contracts.eth_pool.methods
        .stake(
          yam
            .toBigN(200)
            .times(yam.toBigN(10 ** 18))
      ...
      await yam.contracts.ampl_pool.methods.stake("5000000000000000").send({
        from: user,
        gas: 300000,
      });

      await yam.testing.expectThrow(
        yam.contracts.ampl_pool.methods.withdraw("5016536322915820").send({
          from: user,
          gas: 300000,
        }),
        ""
  ...
  describe("incentivizer pool", () => {
    test("joining and exiting", async () => {
      ...
      await yam.contracts.eth_pool.methods.stake("2000000000000000000000").send({
        from: user,
        gas: 300000,
      });
      ...
      await yam.contracts.yam.methods.approve(yam.contracts.uni_router.options.address, -1).send({
        from: user,
        gas: 80000,
      });
      //console.log("approve ycrv")
      await yam.contracts.ycrv.methods.approve(yam.contracts.uni_router.options.address, -1).send({
        from: user,
        gas: 80000,
      });
      ...
      await yam.contracts.uni_router.methods
        .addLiquidity(
      ...
      let pair = await yam.contracts.uni_fact.methods.getPair(yam.contracts.yam.options.address, yam.contracts.ycrv.options.address).call();

      yam.contracts.uni_pair.options.address = pair;
      let bal = await yam.contracts.uni_pair.methods.balanceOf(user).call();

      await yam.contracts.uni_pair.methods.approve(yam.contracts.ycrv_pool.options.address, -1).send({
        from: user,
        gas: 300000,
      });
    ...
    test("rewards from pool 1s eth with rebase", async () => {
      ...
      await yam.contracts.uni_router.methods
        .swapExactTokensForTokens(
          ...
          100000,
          [yam.contracts.ycrv.options.address, yam.contracts.yam.options.address],
          user,
          1596740361 + 10000000
        )
        .send({
      ...
      let two_fity = yam
        ...
        .times(yam.toBigN(10 ** 3))
        .times(yam.toBigN(10 ** 18));
      expect(yam.toBigN(yam_bal2).minus(yam.toBigN(yam_bal)).toNumber()).toBeGreaterThan(two_fity.toNumber());
    });
    test("rewards from pool 1s eth with negative rebase", async () => {
      ...
      await yam.contracts.uni_router.methods
        .swapExactTokensForTokens(
          "1000000000000000000000",
          100000,
          [yam.contracts.yam.options.address, yam.contracts.ycrv.options.address],
          user,
          1596740361 + 10000000
        )
        .send({
      ...
      let two_fity = yam
        ...
        .times(yam.toBigN(10 ** 3))
        .times(yam.toBigN(10 ** 18));
      expect(yam.toBigN(yam_bal2).minus(yam.toBigN(yam_bal)).toNumber()).toBeLessThan(two_fity.toNumber());
    });
  });
  ...
  describe("yfi", () => {
    test("rewards from pool 1s yfi", async () => {
      ...
      await yam.contracts.yfi_pool.methods.stake("500000000000000000000").send({
        from: user,
        gas: 300000,
      });
  ...
  describe("comp", () => {
    test("rewards from pool 1s comp", async () => {
      ...
      await yam.contracts.comp_pool.methods.stake("50000000000000000000000").send({
        from: user,
        gas: 300000,
      });
  ...
  describe("lend", () => {
    test("rewards from pool 1s lend", async () => {
      await yam.testing.resetEVM("0x2");
      await yam.web3.eth.sendTransaction({
        from: user2,
        to: lend_account,
        value: yam.toBigN(100000 * 10 ** 18).toString(),
      });
      ...
      await yam.contracts.lend_pool.methods.stake("10000000000000000000000000").send({
        from: user,
        gas: 300000,
      });
  ...
  describe("link", () => {
    test("rewards from pool 1s link", async () => {
      ...
      await yam.contracts.link_pool.methods.stake("10000000000000000000000000").send({
        from: user,
        gas: 300000,
      });
  ...
  describe("mkr", () => {
    test("rewards from pool 1s mkr", async () => {
      ...
      await yam.contracts.mkr_pool.methods.stake("10000000000000000000000").send({
        from: user,
        gas: 300000,
      });
  ...
  describe("snx", () => {
    test("rewards from pool 1s snx", async () => {
      ...
      await yam.contracts.snx_pool.methods.stake(snx_bal).send({
        from: user,
        gas: 300000,
      });
