        ...
        <Card>
          <CardContent>
            ...
            <Question active={activeSlug === "yam-token"} question="What is YAM?" slug="yam-token">
              <span>
                YAM is the governance token for the YAM protocol. Using token voting, YAM holders have direct influence over the YAM treasury and
                direction of the protocol. Governance discussions take place on the{" "}
            ...
            <Question active={activeSlug === "rebase"} question="What is rebasing?" slug="rebase">
              <span>
                ...
                and decrease supply when price is below the target. YAM is currently pegged to 1 USDC, and uses the YAM/ETH and ETH/USDC Sushiswap
              ...
              <span>
                Every YAM holder gets the same increase or decrease in supply every rebase. However, this increase or decrease is offset by the
                subsequent increase or decrease in price.
              </span>
            </Question>
            <Question active={activeSlug === "rebase-math"} question="What is the math behind each rebase?" slug="rebase-math">
            ...
            <Question active={activeSlug === "rebase-supply"} question="Does this mean I gain or lose money every rebase?" slug="rebase-supply">
              <span>
                No. The Uniswap liquidity pools are in sync with every rebase. This means that if supply is increased by 20% in a rebase, price will
                drop 20% to offset it.{" "}
              </span>
              <span>
                Imagine the following scenario. YAM is at $2 and you hold 100 YAM. This means your YAM holdings are $200. A rebase comes and it's a
                positive 20% rebase. You now have 120 YAM but the price will go $1.67, so your YAM holdings are still worth $200!
              </span>
            </Question>
            <Question active={activeSlug === "treasury"} question="How does YAM have a treasury?" slug="treasury">
              <span>
                In the Yam protocol, when a positive rebase occurs, 5% of the YAM rebase amount is minted and sold for ETH via the YAM/ETH Sushiswap
            ...
            <Question active={activeSlug === "farming"} question="Can I farm YAM?" slug="farming">
              <span>
                Currently check: <RouterLink to="/farm">Farm</RouterLink> to know if you are able to farm.
              </span>
            </Question>
            <Question active={activeSlug === "scaling-factor"} question="What is the scaling factor?" slug="scaling-factor">
              <span>
                Because YAM supply is constantly changing due to rebases, it’s hard to keep up with the ever changing supply amount. Yam.finance
                provides a scaling factor that you can use which allows you to go from initial Yam v3 supply amount to today’s supply amount.
              </span>
            </Question>
            <Question active={activeSlug === "yusd"} question="What is yUSD?" slug="yusd">
              <span>
                yUSD is an interest earning stablecoin generated from{" "}
                <ExternalLink href="https://yearn.finance/vaults">yearn.finance vaults</ExternalLink>. Users are able to deposit yCRV (generated{" "}
                <ExternalLink href="https://www.curve.fi/iearn/deposit">here</ExternalLink>) into the vaults which then yield interest on the deposit
                over time.
              </span>
            </Question>
          </CardContent>
